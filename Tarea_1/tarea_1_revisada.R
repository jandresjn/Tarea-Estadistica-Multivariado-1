...
ggsave("graficos/1a_dist_grupo_a.png", p1_a, width=8, height=4, bg="white")
ggsave("graficos/1b_dist_grupo_b.png", p1_b, width=8, height=4, bg="white")
...
print(p_heatmap)
ggsave("graficos/2_correlacion.png", p_heatmap, width=6, height=6, bg="white")
...
print(p_scree)
ggsave("graficos/3_screeplot.png", p_scree, width=6, height=4, bg="white")
...
print(p_ind)
ggsave("graficos/4_nube_individuos.png", p_ind, width=7, height=5, bg="white")
...
print(p_var)
ggsave("graficos/5_circulo_correlacion.png", p_var, width=6, height=6, bg="white")
...
print(p_biplot)
ggsave("graficos/6_biplot.png", p_biplot, width=8, height=6, bg="white")
